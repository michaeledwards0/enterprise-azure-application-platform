...
| **2**(docs/phase-1-landing-zone/README.md) | [**Enterprise Networking**](docs/phase-1-landing-zone/README.md) | Hub-and-spoke VNets, subnets, NSGs, routing, private DNS | Planned |
